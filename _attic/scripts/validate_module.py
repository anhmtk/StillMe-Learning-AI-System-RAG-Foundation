...
def validate_module(module: str) -> bool:
    ...
    print("  🔍 Checking for forbidden type: ignore comments...")
    type_ignore_result = run_command(
        ["python", "scripts/deny_type_ignore.py", module], module
    )

    if type_ignore_result["success"]:
        print("  ✅ No forbidden type: ignore comments found")
    else:
        print("  ❌ Found forbidden type: ignore comments")
