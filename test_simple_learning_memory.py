#!/usr/bin/env python3
"""
Simple test for Daily Learning + Memory Integration
...
def test_simple_learning_memory():
    """Test integration between DailyLearningManager and LayeredMemoryV1"""
    print("🧠 Testing Simple Daily Learning + Memory Integration")
    print("=" * 60)
    ...
    try:
        ...
        print("1. Creating LayeredMemoryV1...")
        memory_manager = LayeredMemoryV1()
        print("✅ LayeredMemoryV1 created")
        
        print("\n2. Creating DailyLearningManager with Memory Integration...")
        ...
        print("\n3. Testing Learning Case Creation...")
        ...
        print("\n7. Testing Direct Memory Access...")
...
if __name__ == "__main__":
    success = test_simple_learning_memory()
    if success:
