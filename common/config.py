    ...
    def get_with_type(self, key: str, expected_type: type, default: T = None) -> T:
        ...
        if not isinstance(value, expected_type):
            if default is not None:
                return default
            raise TypeError(f"Configuration key '{key}' expected {expected_type.__name__}, got {type(value).__name__}")
...
def load_framework_config(config_path: str = "config/framework_config.json") -> ConfigManager:
