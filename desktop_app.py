#!/usr/bin/env python3
"""
StillMe Desktop App - Beautiful UI
...
class StillMeDesktopApp:
    ...
    def create_ui(self):
        ...
        # Status frame
        status_frame = tk.Frame(main_frame, bg="#f8fafc")
        ...
        # Chat frame
        chat_frame = tk.Frame(main_frame, bg="#f8fafc")
        ...
        # Input frame
        input_frame = tk.Frame(chat_frame, bg="#f8fafc")
    ...
    def add_message(self, sender, message, msg_type):
        ...
        self.chat_text.tag_configure("ai", foreground="#10b981", font=("Arial", 11, "bold"))
        self.chat_text.tag_configure("system", foreground="#6b7280", font=("Arial", 11, "bold"))
        self.chat_text.tag_configure("error", foreground="#ef4444", font=("Arial", 11, "bold"))
        self.chat_text.tag_configure("timestamp", foreground="#9ca3af", font=("Arial", 9))
