...
class RSSFetcher:
    ...
    def __init__(self):
        ...
        self.feeds = [
            ...
            # Social Sciences
            "https://www.psychologicalscience.org/rss",  # APS Main Feed - updated URL (feed returned 403)
            ...
            "https://www.ncronline.org/feed/",  # National Catholic Reporter - updated URL (no trailing slash returned 404)
