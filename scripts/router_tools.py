...
class RouterTools:
    ...
    def _test_complexity_analysis(self):
        ...
        try:
            ...
            if score >= 0.4:
                return {
                    "passed": False,
                    "error": f"Simple prompt got high complexity: {score}",
                }
            ...
            if score < 0.7:
                return {
                    "passed": False,
                    "error": f"Complex prompt got low complexity: {score}",
                }
    ...
    def _test_model_selection(self):
        ...
        try:
            ...
            if model != "gemma2:2b":
                return {
                    "passed": False,
                    "error": f"Simple prompt routed to {model}, expected gemma2:2b",
                }
            ...
            if model != "deepseek-coder:6.7b":
                return {
                    "passed": False,
                    "error": f"Coding prompt routed to {model}, expected deepseek-coder:6.7b",
                }
            ...
            if model != "deepseek-chat":
                return {
                    "passed": False,
                    "error": f"Complex prompt routed to {model}, expected deepseek-chat",
                }
    ...
    def _test_fallback_detection(self):
        ...
        try:
            ...
            if not should_fallback:
                return {
                    "passed": False,
                    "error": "Negative feedback should trigger fallback",
                }
            ...
            if should_fallback:
                return {
                    "passed": False,
                    "error": "Positive feedback should not trigger fallback",
                }
    ...
    def _test_edge_cases(self):
        ...
        try:
            ...
            if score != 0.0:
                return {
                    "passed": False,
                    "error": f"Empty prompt should have complexity 0, got {score}",
                }
            ...
            if score <= 0.0:
                return {
                    "passed": False,
                    "error": f"Very long prompt should have some complexity, got {score}",
                }
        ...
        try:
            ...
            for prompt, expected_model in test_cases:
                ...
                if model != expected_model:
                    return {
                        "passed": False,
                        "error": f'Prompt "{prompt}" routed to {model}, expected {expected_model}',
                    }
    ...
    def _test_performance_under_load(self):
        ...
        try:
            ...
            if avg_time > 0.01:  # 10ms
                return {
                    "passed": False,
                    "error": f"Average routing time {avg_time:.4f}s, expected < 0.01s",
                }
    ...
    def _test_analysis_speed(self):
        ...
        try:
            ...
            if avg_time > 0.005:  # 5ms
                return {
                    "passed": False,
                    "error": f"Average analysis time {avg_time*1000:.2f}ms, expected < 5ms",
                }
    ...
    def _test_memory_usage(self):
        ...
        try:
            ...
            if memory_increase > 100:  # 100MB
                return {
                    "passed": False,
                    "error": f"Memory increase {memory_increase:.1f}MB, expected < 100MB",
                }
            ...
            return {
                "passed": True,
                "note": "psutil not available, skipping memory test",
            }
        except Exception as e:
            return {"passed": False, "error": str(e)}
        ...
        try:
            ...
            for i in range(1, len(times)):
                if times[i] > times[i - 1] * 10:  # 10x increase is too much
                    return {
                        "passed": False,
                        "error": f"Time increase too large: {times[i-1]*1000:.2f}ms -> {times[i]*1000:.2f}ms",
                    }
    ...
    def _test_simple_prompts(self):
        ...
        try:
            ...
            if accuracy < 0.8:  # 80%
                return {
                    "passed": False,
                    "error": f"Simple prompts accuracy {accuracy:.1%}, expected >= 80%",
                }
    ...
    def _test_coding_prompts(self):
        ...
        try:
            ...
            if accuracy < 0.8:  # 80%
                return {
                    "passed": False,
                    "error": f"Coding prompts accuracy {accuracy:.1%}, expected >= 80%",
                }
    ...
    def _test_complex_prompts(self):
        ...
        try:
            ...
            if accuracy < 0.8:  # 80%
                return {
                    "passed": False,
                    "error": f"Complex prompts accuracy {accuracy:.1%}, expected >= 80%",
                }
    ...
    def run_debug(self, prompt: str):
        ...
        return {
            ...
            "keywords": {"coding": found_coding, "complex": found_complex},
        }
    ...
    def _validate_configuration(self):
        ...
        try:
            ...
            if thresholds["simple"] >= thresholds["medium"]:
                return {
                    "passed": False,
                    "error": f'Invalid threshold order: simple={thresholds["simple"]}, medium={thresholds["medium"]}',
                }
    ...
    def _validate_performance(self):
        ...
        try:
            ...
            if avg_time > 0.01:  # 10ms
                return {
                    "passed": False,
                    "error": f"Average analysis time {avg_time*1000:.2f}ms, expected < 10ms",
                }
    ...
    def _validate_accuracy(self):
        ...
        try:
            ...
            if accuracy < 0.8:  # 80%
                return {
                    "passed": False,
                    "error": f"Accuracy {accuracy:.1%}, expected >= 80%",
                }
...
def main():
    ...
    parser.add_argument(
        "--benchmark", type=int, default=1000, help="Run performance benchmark"
    )
