...
class HealthChecker:
    ...
    def check_agentdev(self) -> HealthCheck:
        ...
        try:
            ...
            from agent_dev.core.agentdev_unified import AgentDevUnified
            
            # Create a simple test instance
            agentdev = AgentDevUnified(project_root=".")
            
            # Test basic functionality
            test_result = agentdev.execute_task("test health check", mode="SIMPLE")
    ...
    def readiness_probe():
        ...
        try:
            ...
            if health_response.status == HealthStatus.HEALTHY:
                ...
                return health_response.__dict__, 200  # Still ready but degraded
            else:
                return health_response.__dict__, 503  # Not ready
