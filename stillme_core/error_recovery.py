...
class RetryManager:
    ...
    async def execute_async(self, func: Callable[..., T], *args, **kwargs) -> OperationResult:
...
class ErrorRecoveryManager:
    ...
    def execute_with_recovery(self, func: Callable[..., T], 
    ...
    async def execute_with_recovery_async(self, func: Callable[..., T], 
                                        circuit_breaker_name: str = "default",
                                        retry_config_name: str = "default",
                                        *args, **kwargs) -> OperationResult:
