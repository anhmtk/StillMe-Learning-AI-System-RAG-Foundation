...
class PIIRedactor:
    ...
    def _build_patterns(self) -> Dict[PIIType, List[Tuple[re.Pattern, float]]]:
        ...
        patterns[PIIType.EMAIL] = [
            ...
            (re.compile(r'\b[A-Za-z0-9._%+-]+\s*@\s*[A-Za-z0-9.-]+\s*\.\s*[A-Z|a-z]{2,}\b'), 0.90),
        ...
        patterns[PIIType.NAME] = [
            ...
            (re.compile(r'\b[\u4e00-\u9fff]+\b', re.UNICODE), 0.60),  # Chinese characters
    ...
    def _redact_email(self, email: str) -> str:
        ...
        if '.' in domain:
            ...
            if len(domain_parts) >= 2:
                redacted_domain = domain_parts[0][0] + '*' * (len(domain_parts[0]) - 1) + '.' + domain_parts[-1]
            else:
