...
def main():
    ...
    parser.add_argument("--run", action="store_true", help="Run supervisor to collect signals and propose lessons")
    parser.add_argument("--approve", nargs="+", help="Approve lesson proposals by IDs")
    parser.add_argument("--list", action="store_true", help="List current lesson proposals")
    parser.add_argument("--current", action="store_true", help="Show current knowledge pack")
