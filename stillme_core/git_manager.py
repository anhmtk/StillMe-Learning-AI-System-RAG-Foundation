...
class GitManager:
        def __init__(self, repo_path: str = "."):
            try:
                ...
                logger.error(f"Path {repo_path} is not a Git repository. Please initialize git.")
                exit(1)
        ...
        def commit_changes(self, message: str) -> bool:
            try:
                ...
                if self.repo.is_dirty(untracked_files=True): # Check if there are actual changes to commit
