...
class ModuleGovernanceSystem:
    ...
    def _discover_modules(self):
        ...
        try:
            ...
            discovery_paths = ["modules/", "stillme_core/", "api/", "utils/"]
    ...
    def _load_module_configurations(self):
        ...
        try:
            ...
            self.logger.info(
                f"✅ Loaded configurations for {len(self.module_configs)} modules"
            )
    ...
    def _setup_governance_monitoring(self):
        ...
        try:
            ...
            self.integration_bridge.register_endpoint(
                "POST",
                "/governance/module/restart",
                self._restart_module,
                auth_required=True,
            )
            self.integration_bridge.register_endpoint(
                "GET",
                "/governance/health",
                self._get_governance_health,
                auth_required=True,
            )
    ...
    def _start_governance_monitoring(self):
        ...
        try:
            ...
            self.governance_thread = threading.Thread(
                target=self._governance_monitoring_loop, daemon=True
            )
    ...
    def _update_governance_metrics(self):
        ...
        try:
            ...
            self.governance_metrics.avg_health_score = (
                total_health_score / len(self.modules) if self.modules else 0.0
            )
        ...
        try:
            for module_name, module in self.modules.items():
                if module.status == ModuleStatus.RUNNING:
                    ...
                    self.performance_metrics["health_check_times"].append(
                        health_check_time
                    )
                    ...
                    if health_score < 0.5:
                        ...
                        self.logger.warning(
                            f"⚠️ Module {module_name} health score low: {health_score}"
                        )
        ...
        try:
            return {
                ...
                "data": {
                    ...
                    "performance_metrics": {
                        "avg_startup_time": (
                            sum(self.performance_metrics["startup_times"])
                            / len(self.performance_metrics["startup_times"])
                            if self.performance_metrics["startup_times"]
                            else 0
                        ),
                        "avg_shutdown_time": (
                            sum(self.performance_metrics["shutdown_times"])
                            / len(self.performance_metrics["shutdown_times"])
                            if self.performance_metrics["shutdown_times"]
                            else 0
                        ),
                        ...
                        "avg_restart_time": (
                            sum(self.performance_metrics["restart_times"])
                            / len(self.performance_metrics["restart_times"])
                            if self.performance_metrics["restart_times"]
                            else 0
                        ),
                    },
                },
        ...
        try:
            ...
            for module_name, module in self.modules.items():
                modules_data[module_name] = {
                    ...
                    "startup_time": (
                        module.startup_time.isoformat() if module.startup_time else None
                    ),
                    "shutdown_time": (
                        module.shutdown_time.isoformat()
                        if module.shutdown_time
                        else None
                    ),
    ...
    async def _start_module(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "data": {"module_name": module_name, "started": success},
            }
    ...
    async def _stop_module(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "success" if success else "error",
                "data": {"module_name": module_name, "stopped": success},
            }
    ...
    async def _restart_module(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "success" if success else "error",
                "data": {"module_name": module_name, "restarted": success},
            }
