        ...
        try:
            ...
            report = {
                ...
                "agentdev_distribution": {
                    "excellent": len([s for s in scores if s.overall_agentdev_score >= 0.8]),
                    "good": len([s for s in scores if 0.6 <= s.overall_agentdev_score < 0.8]),
                    "fair": len([s for s in scores if 0.4 <= s.overall_agentdev_score < 0.6]),
