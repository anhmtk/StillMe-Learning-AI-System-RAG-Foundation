...
\item \textbf{Vector Database}: ChromaDB with collections \texttt{stillme\_knowledge} (learned content) and \texttt{stillme\_conversations} (conversation history). Collections are stored separately for semantic search.
