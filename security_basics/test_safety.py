...
class TestSandboxIsolation:
    ...
    def test_sandbox_isolation(self):
        ...
        try:
            ...
            agentdev = AgentDevUnified(str(sandbox))
    ...
    def test_prompt_injection_defense(self):
        ...
        try:
            ...
            for prompt in malicious_prompts:
                result = agentdev.execute_task(prompt, AgentMode.SENIOR)
    ...
    def test_instruction_override_defense(self):
        ...
        try:
            ...
            for attempt in override_attempts:
                result = agentdev.execute_task(attempt, AgentMode.SENIOR)
                results.append(result)
...
class TestResourceLimits:
    ...
    def test_memory_usage_limits(self):
        ...
        try:
            ...
            result = agentdev.execute_task(memory_intensive_task, AgentMode.SENIOR)
    ...
    def test_execution_time_limits(self):
        ...
        try:
            ...
            result = agentdev.execute_task(time_intensive_task, AgentMode.SENIOR)
            end_time = time.time()
