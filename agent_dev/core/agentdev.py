...
from agent_dev.monitoring.metrics import MetricsCollector, record_event, timer
...
class AgentDev:
    ...
    def execute(self, task: str, mode: Any = None) -> str:
        ...
        if compliance_results:
            ...
            self.monitor.record_event("tasks_blocked", 1.0, {"rule": compliance_results[0].rule_name})
    ...
    def receive_feedback(self, user_id: str, feedback: str, session_id: str | None = None) -> str:
