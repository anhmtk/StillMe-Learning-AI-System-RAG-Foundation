...
│   ├── __init__.py
│   ├── agentdev.py                  # AgentDev with validation
...
└── docs/                           # Documentation
    ...
    ├── AGENTDEV_GUIDE.md           # AgentDev guide
    ├── AGENTDEV_README.md          # AgentDev README
...
- `AGENTDEV_GUIDE.md` - Hướng dẫn AgentDev
- `AGENTDEV_README.md` - README AgentDev
