"""
Main CLI application for StillMe AI Framework

This module provides the main command-line interface for AgentDev and StillMe.
"""
...
from .commands import agent, build, config, observability, quality, router, status
...
app.add_typer(build.app, name="build", help="Build, test, and package applications")
app.add_typer(
    observability.app,
    name="observability",
...
app.add_typer(
    router.app, name="router", help="Intelligent routing and coordination commands"
)
