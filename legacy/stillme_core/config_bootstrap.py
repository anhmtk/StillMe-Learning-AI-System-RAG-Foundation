...
def _create_env_from_example(
    example_path: pathlib.Path, env_path: pathlib.Path
) -> None:
...
def _get_reflection_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "learning": {"enabled": True, "adaptive_mode": True, "feedback_weight": 0.7},
        "safety": {
...
def _get_dev_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "debug": True,
        "log_level": "DEBUG",
        "api_keys": {"openai": "sk-dev-xxxx", "openrouter": "sk-or-dev-xxxx"},
        "services": {
            "ollama": {
        ...
        "features": {"dry_run": True, "mock_providers": True, "offline_mode": True},
    }
...
def _get_prod_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "debug": False,
        "log_level": "INFO",
        "api_keys": {"openai": "sk-prod-xxxx", "openrouter": "sk-or-prod-xxxx"},
        "services": {
            "ollama": {
        ...
        "features": {"dry_run": False, "mock_providers": False, "offline_mode": False},
        "security": {
            "rate_limiting": True,
            "content_filtering": True,
            "pii_redaction": True,
...
def _get_staging_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "debug": True,
        "log_level": "INFO",
        "api_keys": {"openai": "sk-staging-xxxx", "openrouter": "sk-or-staging-xxxx"},
        "services": {
            "ollama": {
        ...
        "features": {"dry_run": True, "mock_providers": False, "offline_mode": False},
    }
