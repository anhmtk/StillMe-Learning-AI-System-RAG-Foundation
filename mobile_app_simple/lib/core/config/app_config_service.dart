...
class AppConfigService {
  ...
  String get _flavor {
    // Detect flavor from build config or environment
    if (kDebugMode) {
      return 'dev';
    }
    return 'prod';
  ...
  String get _configAssetPath => 'assets/config/app_config.$_flavor.json';
  
  Future<AppConfig> loadConfig() async {
    try {
      // Load flavor-specific config from assets
