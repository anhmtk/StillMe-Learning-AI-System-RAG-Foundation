...
class IdentityHandler:
    ...
    def __init__(self, config_path: str = "config/framework_config.json"):
        ...
        self.identity_keywords = {
            ...
            "en": [
                ...
                "which country", "what country", "korean", "korea", "origin",
                "where from", "come from", "belong to", "author", "creator",
                "developer", "founder", "inventor", "made by", "created by"
            ]
        }
        ...
        self.architecture_keywords = {
            ...
            "en": [
                ...
                "modules", "framework", "system", "mechanism", "how it works",
                "agentdev", "agent dev", "dev agent", "programming", "code",
                "write code", "run tests", "dev-ops", "internal architecture",
    ...
    def _get_default_config(self) -> Dict:
        ...
        return {
            ...
            "templates": {
                "vi": ["Em là StillMe AI, được tạo ra bởi Anh Nguyễn (người Việt Nam) với sự đồng hành của OpenAI, Google, DeepSeek."],
                "en": ["I'm StillMe AI, created by Anh Nguyen (Vietnamese) with support from OpenAI, Google, DeepSeek."]
            }
        }
    ...
    def generate_identity_response(self, message: str, locale: str = "vi") -> Optional[str]:
        """
    ...
    def generate_architecture_response(self, message: str, locale: str = "vi") -> Optional[str]:
        """
        ...
        logger.info(f"Architecture response generated - locale: {response_locale}, template_id: {hash(selected_template)}")
        
        return selected_template
    
    def generate_secure_response(self, message: str, locale: str = "vi") -> Optional[str]:
        """
