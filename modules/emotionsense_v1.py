...
class EmotionSenseV1:
    ...
    async def _initialize_torch_models(self):
        ...
        try:
            ...
            try:
                ...
                fallback_model = model_config.get("fallback_model", "bert-base-multilingual-cased")
    ...
    async def _initialize_rule_based_models(self):
        ...
        try:
            ...
            if SKLEARN_AVAILABLE:
                ...
                self.logger.info("Rule-based model initialized (basic keyword matching)")
    ...
    def detect_emotion(self, text: str, language: str = "auto", user_id: str = "default") -> Dict[str, Any]:
        ...
        try:
            ...
            if not text or not text.strip():
                return self._create_emotion_result("neutral", 0.0, "Empty text", language)
    ...
    def _detect_emotion_ml(self, text: str, language: str) -> Dict[str, Any]:
        ...
        try:
            ...
            emotion_scores = self._classify_emotion_from_embeddings(embeddings, text, language)
    ...
    def _detect_emotion_keyword_based(self, text: str, language: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for emotion, config in emotion_keywords.items():
                ...
                intensity_words = ["rất", "cực kỳ", "vô cùng", "tuyệt vời", "kinh khủng"]
            ...
            return self._create_emotion_result("neutral", 0.0, f"Error: {str(e)}", language)
    
    def _create_emotion_result(self, emotion: str, confidence: float, method: str, language: str, error_code: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _add_to_history(self, user_id: str, text: str, result: Dict[str, Any], language: str):
    ...
    def get_emotion_history(self, user_id: str, limit: int = 100) -> List[Dict[str, Any]]:
