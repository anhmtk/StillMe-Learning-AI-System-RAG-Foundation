...
class TestCommunicationStyleManager:
    ...
    def test_good_response_unchanged(self):
        ...
        good_response = "Python là ngôn ngữ lập trình phổ biến. Bạn muốn học về phần nào?"
    ...
    def test_optimization_stats(self):
        ...
        original = "Tất nhiên rồi, tôi rất sẵn lòng giúp đỡ bạn. Python là ngôn ngữ lập trình."
    ...
    def test_complex_verbose_response(self):
        ...
        assert any(keyword in result.lower() for keyword in ["file", "lỗi", "thông tin"])
