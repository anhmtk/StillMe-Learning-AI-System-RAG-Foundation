...
from stillme_core.supervisor import DailySupervisor, LessonProposal
...
class TestSupervisorFlow:
    ...
    def test_propose_lessons(self, tmp_path):
        ...
        signals = {
            "timestamp": "2025-09-06T14:50:00",
            "agentdev_logs": [
                {"action": "test_action", "ok": False, "stdout_tail": "Test error"}
            ],
            "memory_usage": {"risk_score": 0.8, "test_files": ["test_memory.py"]},
            "error_patterns": [{"action": "test_action", "error": "Test error"}],
        }
