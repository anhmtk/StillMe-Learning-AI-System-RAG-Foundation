...
from stillme_core.risk.risk_assessor import RiskAssessor, RiskLevel, RiskCategory
from stillme_core.quality.quality_governor import QualityGovernor, QualityMetric
from stillme_core.error_recovery import ErrorRecoveryManager, RetryConfig, CircuitBreakerConfig
...
""")
    ...
    def test_detect_test_framework(self):
        ...
        framework = self.executor._detect_test_framework(str(Path(self.temp_dir) / "test_unittest.py"))
...
class TestAttackSimulator:
    ...
    def test_analyze_response(self):
        ...
        vulnerability = self.simulator._analyze_response(
            mock_response, AttackType.SQL_INJECTION, 
...
class TestErrorRecovery:
    ...
    def test_retry_manager(self):
        ...
        from stillme_core.error_recovery import RetryManager, RetryConfig
    ...
    def test_circuit_breaker(self):
        ...
        from stillme_core.error_recovery import CircuitBreaker, CircuitBreakerConfig, CircuitState
