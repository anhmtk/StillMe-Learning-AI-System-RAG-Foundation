...
async def content_filter_instance(mock_openrouter_client_fixture):
    ...
    with patch('modules.content_integrity_filter.OpenRouterClient', return_value=mock_openrouter_client_fixture):
...
async def test_filter_content_fully_safe(mock_violation_logger, content_filter_instance, mock_openrouter_client_fixture):
...
@pytest.mark.asyncio
@patch('modules.content_integrity_filter.violation_logger')
async def test_filter_content_pre_filter_blocked_critical(mock_violation_logger, content_filter_instance, mock_openrouter_client_fixture):
...
@pytest.mark.asyncio
@patch('modules.content_integrity_filter.violation_logger')
async def test_filter_content_quality_violation_and_fact_check(mock_violation_logger, content_filter_instance, mock_openrouter_client_fixture):
    """
...
@pytest.mark.asyncio
@patch('modules.content_integrity_filter.violation_logger')
async def test_filter_content_llm_error_fallback_in_main_filter(mock_violation_logger, content_filter_instance, mock_openrouter_client_fixture):
