...
class TestLearnedSolutionRepo:
    ...
    def test_create_solution(self, solution_repo: LearnedSolutionRepo):
        ...
        solution = solution_repo.create_solution(
            error_type="syntax_error", solution="Check for missing semicolon"
        )
    ...
    def test_update_success_rate(self, solution_repo: LearnedSolutionRepo):
        ...
        assert (
            updated_solution.success_rate <= 0.9
        )  # Should be lower or equal after failure
...
class TestIntegration:
    ...
    def test_full_workflow(
        ...
        user_prefs_repo: UserPreferencesRepo,
        rule_repo: RuleRepo,
        solution_repo: LearnedSolutionRepo,
