...
from common.config import ConfigManager, StillMeConfig, load_framework_config, load_module_config
from common.logging import StructuredLogger, JsonFormatter, StandardFormatter, get_logger
from common.errors import (
    StillMeException, StillMeError, StillMeWarning, ConfigurationError,
    ModuleError, APIError, SecurityError, ValidationError, NetworkError,
    TimeoutError, ResourceError, AuthenticationError, AuthorizationError,
    CircuitBreakerError, ErrorHandler, ErrorRecovery
)
from common.retry import (
    RetryManager, RetryConfig, CircuitBreaker, CircuitBreakerConfig,
    CircuitState, retry_with_backoff, circuit_breaker
)
...
class TestConfigManager:
    ...
    def test_environment_variable_override(self):
        ...
        with patch.dict(os.environ, {"STILLME_KEY1": "env_value", "STILLME_KEY2": "true"}):
...
class TestErrorHandling:
    ...
    def test_stillme_exception(self):
        ...
        error = StillMeException("Test error", error_code="TEST_ERROR", context={"key": "value"})
    ...
    def test_error_recovery(self):
        ...
        result = ErrorRecovery.retry_with_backoff(failing_function, max_retries=3, base_delay=0.01)
...
class TestRetryMechanisms:
    ...
    def test_retry_manager_async(self):
        ...
        async def async_test():
            ...
            config = RetryConfig(max_attempts=2, base_delay=0.01, exceptions=(ValueError,))
            manager = RetryManager(config)
...
class TestIntegration:
    ...
    def test_retry_with_error_handling(self):
        ...
        config = RetryConfig(max_attempts=3, base_delay=0.01, exceptions=(NetworkError,))
        manager = RetryManager(config)
