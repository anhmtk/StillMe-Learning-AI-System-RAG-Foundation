...
class TestAPIBridge:
    ...
    def test_dev_agent_bridge_endpoint(self):
        ...
        with TestClient(app) as client:
            ...
            payload = {"prompt": "Run unit tests", "mode": "safe"}
            ...
            with patch("api_server.AgentController") as mock_controller_class:
                ...
                mock_controller.run_agent.assert_called_once_with(
                    goal="Run unit tests", max_steps=3
                )

    def test_dev_agent_bridge_with_different_prompt(self):
        """Test POST /dev-agent/bridge with different prompt"""
        with TestClient(app) as client:
            payload = {"prompt": "Fix failing tests", "mode": "fast"}
            ...
            with patch("api_server.AgentController") as mock_controller_class:
                ...
                mock_controller.run_agent.assert_called_once_with(
                    goal="Fix failing tests", max_steps=3
                )
