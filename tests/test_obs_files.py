...
from stillme_core.logging_utils import AgentDevLogger, log_step, log_session_start, log_session_end
from stillme_core.metrics import AgentDevMetrics, record_session, get_summary
...
class TestMetrics:
    def test_record_session(self, tmp_path):
        ...
        with open(metrics.metrics_file, "r", encoding="utf-8") as f:
            data = json.load(f)
