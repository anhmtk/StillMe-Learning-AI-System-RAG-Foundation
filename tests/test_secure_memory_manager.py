...
class TestSecureMemoryManager:
    ...
    async def test_key_rotation(self, memory_manager):
        ...
        memory_manager.key_created_date = memory_manager.key_created_date - timedelta(days=2)
        ...
        assert memory_manager.key_created_date > memory_manager.key_created_date - timedelta(days=2)
...
class TestSecureMemoryErrorHandling:
    ...
    async def test_restore_nonexistent_backup(self, memory_manager):
        ...
        assert memory_manager.error_count >= 0  # May not always increase for file not found
...
class TestSecureMemoryIntegration:
    ...
    async def test_vietnamese_text_handling(self, memory_manager):
        ...
        vietnamese_text = "Xin chào! Tôi là một AI thông minh. Tôi có thể hiểu và xử lý tiếng Việt."
