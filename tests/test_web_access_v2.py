...
from web_tools import WebToolsRegistry, search_news, github_trending, hackernews_top, google_trends
...
from cache.web_cache import WebCache, get_cached_data, cache_data, generate_cache_key
