#!/usr/bin/env python3
"""
AgentDev Persistence Repo Simple Tests
Target: agent_dev/persistence/repo.py (26% → 60%)
STRICT MODE - Real functionality testing
"""
...
class TestPersistenceRepoSimple:
    ...
    def test_feedback_repo_create_feedback(self):
        ...
        # Create real feedback event using the model
        from agent_dev.persistence.models import FeedbackModel
    ...
    def test_feedback_repo_update_feedback(self):
        ...
        updated = repo.update_feedback(created.id, {
            "feedback": "Updated content"
        })
        
        assert updated is not None
        assert updated.feedback == "Updated content"
    ...
    def test_user_preferences_repo_create_preferences(self):
        ...
        from agent_dev.persistence.models import UserPreferencesModel
    ...
    def test_rule_repo_create_rule_hit(self):
        ...
        from agent_dev.persistence.models import RuleHitModel
        rule_hit = RuleHitModel(
            rule_name="test_rule",
    ...
    def test_metric_repo_record_metrics(self):
        ...
        from agent_dev.persistence.models import MetricsRecordModel
        metrics = MetricsRecordModel(
            session_id="test_session",
    ...
    def test_agentdev_repo_create_session(self):
        ...
        from agent_dev.persistence.models import AgentDevSessionModel
        session = AgentDevSessionModel(
            session_id="test_session",
            user_id="test_user",
