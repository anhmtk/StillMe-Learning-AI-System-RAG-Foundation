...
from common.templates import (
    TemplateManager, TemplateType, SecurityLevel, TemplateConfig, 
    TemplateContext, SecurityValidator, create_response_template, render_secure_response
)
from common.validation import (
    ValidationEngine, ValidationRule, ValidationResult, ValidationSeverity, 
    DataType, DataValidator, InputSanitizer, validate_user_input, sanitize_user_input
)
from common.errors import ValidationError, SecurityError, StillMeException
...
class TestSecurityValidator:
    ...
    def test_validate_variables(self):
        ...
        SecurityValidator.validate_variables(variables, allowed_variables, required_variables)
...
class TestTemplateManager:
    ...
    def test_save_template_to_file(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            manager = TemplateManager()
            manager.save_template_to_file("test_template", "Hello {{ name }}!", temp_file)
...
class TestValidationEngine:
    ...
    def test_validate_data_missing_required(self):
        ...
        data = {"age": 25}
        rules = [
            ValidationRule("name", DataType.STRING, required=True, severity=ValidationSeverity.CRITICAL),
            ValidationRule("age", DataType.INTEGER, required=True)
        ]
    ...
    def test_validate_data_invalid_type(self):
        ...
        rules = [
            ValidationRule("age", DataType.INTEGER, required=True, severity=ValidationSeverity.CRITICAL)
        ]
    ...
    def test_validate_data_custom_validator(self):
        ...
        rules = [
            ValidationRule("age", DataType.INTEGER, required=True, custom_validator=validate_adult, severity=ValidationSeverity.CRITICAL)
        ]
