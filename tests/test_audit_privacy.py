    ...
    def _load_test_cases(self) -> List[TestCase]:
        ...
        return [
            ...
            TestCase(
                ...
                expected_pii_types=[PIIType.NAME, PIIType.EMAIL, PIIType.PHONE, PIIType.IP_ADDRESS],
                should_redact=True,
            ...
            try:
                ...
                if test_case.should_redact:
                    ...
                    if not all(pii_type in detected_types for pii_type in test_case.expected_pii_types):
                        print(f"FAILED: {test_case.name} - Expected types {test_case.expected_pii_types}, got {detected_types}")
                        continue
                else:
                    if len(matches) > 0:
