...
def test_dev_agent_fast():
    ...
    from api_server import DevAgentRequest, DevAgentResponse, AgentMode
...
def test_dev_agent_safe():
    ...
    assert request.prompt == "Explain how you would plan unit tests for a small Python function."
