...
CSS and JS are loaded from frontend/static/ for Visual Editor support.
"""
...
def render_floating_chat(chat_history: list, api_base: str, is_open: bool = False):
    ...
    # Load CSS and JS from external files (for Visual Editor support)
    ...
    panel_display = 'flex' if is_open else 'none'
