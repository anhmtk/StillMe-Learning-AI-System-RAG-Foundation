...
class MessageProtocol(BaseModel):
    ...
    response_to: Optional[str] = Field(
        default=None, description="ID of message this responds to"
    )
    requires_response: bool = Field(default=False, description="Requires response")
    response_timeout: Optional[int] = Field(
        default=None, description="Response timeout in seconds"
    )
...
class CommandMessage(MessageProtocol):
    ...
    result_location: Optional[str] = Field(
        default=None, description="Result file location"
    )
...
class StatusMessage(MessageProtocol):
    ...
    metrics: Optional[Dict[str, Any]] = Field(
        default=None, description="Component metrics"
    )
...
class NotificationMessage(MessageProtocol):
    ...
    actions: Optional[Dict[str, str]] = Field(
        default=None, description="Available actions"
    )
...
def create_notification(
    title: str, body: str, source: str, target: Optional[str] = None, **kwargs
) -> NotificationMessage:
...
def create_heartbeat(
    source: str, client_info: Optional[Dict[str, Any]] = None, **kwargs
) -> HeartbeatMessage:
