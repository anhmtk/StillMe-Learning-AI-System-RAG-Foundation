...
class WebSocketManager:
    ...
    async def broadcast_status(self, status_message: Dict, exclude: Optional[List[str]] = None):
    ...
    async def broadcast_notification(self, notification: Dict, target_clients: Optional[List[str]] = None):
    ...
    async def send_to_room(self, room_id: str, message: Dict, exclude: Optional[List[str]] = None):
    ...
    async def process_message(self, client_id: str, message: MessageProtocol):
        ...
        try:
            if message.type == MessageType.HEARTBEAT:
                ...
                if client_id in self.connection_metadata:
                    self.connection_metadata[client_id]["last_activity"] = message.timestamp
