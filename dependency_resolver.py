...
class DependencyResolver:
            ...
            try:
                ...
                for line in lines:
                    ...
                    if line.startswith(('import ', 'from ')):
                        ...
                        # Categorize packages
                        if package in ['torch', 'transformers', 'sklearn', 'numpy', 'pandas']:
                            imports["ai_packages"].append(package)
                        elif package in ['fastapi', 'uvicorn', 'starlette', 'asgi_lifespan']:
    ...
    def check_missing_packages(self, imports: Dict[str, List[str]]) -> List[str]:
        ...
        required_packages = [
            "httpx", "openai", "yaml", "psutil", "numpy", "pandas",
            "torch", "transformers", "sklearn", "ollama", "tiktoken",
            "sentence_transformers", "open-interpreter", "asgi-lifespan"
        ]
    ...
    def verify_framework(self) -> bool:
        ...
        # Test run tests
        print("🧪 Chạy tests...")
        exit_code, stdout, stderr = self.run_command("python -m pytest tests/test_secure_memory_manager.py -v")
    ...
    def generate_report(self, imports: Dict[str, List[str]], missing_packages: List[str]) -> None:
