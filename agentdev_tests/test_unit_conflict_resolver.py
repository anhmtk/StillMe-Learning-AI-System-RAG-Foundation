...
from agent_dev.core.conflict_resolver import ConflictResolver, ConflictType, ResolutionStrategy
...
""")
        ...
        code_conflicts = [c for c in conflicts if c.conflict_type == ConflictType.CODE_CONFLICT]
...
""")
        ...
        merge_conflicts = [c for c in conflicts if c.conflict_type == ConflictType.MERGE_CONFLICT]
...
""")
    ...
    def test_conflict_resolution_strategies(self):
        ...
        for conflict in conflicts:
            ...
            for res in resolution:
                ...
                assert res["strategy"] in [ResolutionStrategy.AUTO_RESOLVE, ResolutionStrategy.MANUAL_REVIEW, ResolutionStrategy.REJECT]
    ...
    def test_auto_resolution_capabilities(self):
        ...
        auto_resolve = [r for r in resolution if r["strategy"] == ResolutionStrategy.AUTO_RESOLVE]
    ...
    def test_manual_review_requirements(self):
        ...
        manual_review = [r for r in resolution if r["strategy"] == ResolutionStrategy.MANUAL_REVIEW]
...
""")
    ...
    def test_conflict_resolution_confidence(self):
        ...
        complex_resolution = self.conflict_resolver.resolve_conflicts([complex_conflict])
