...
try:
    if not hasattr(agent_dev.core, "impact_analyzer_improved"):
        agent_dev.core.impact_analyzer_improved = types.ModuleType(
            "impact_analyzer_improved"
        )
        agent_dev.core.impact_analyzer_improved.ImpactAnalyzer = MockImpactAnalyzer
        agent_dev.core.impact_analyzer_improved.ImpactAnalysisResult = (
            MockImpactAnalysisResult
        )
