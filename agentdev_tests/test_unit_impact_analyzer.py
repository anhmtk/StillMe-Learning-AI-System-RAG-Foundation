...
from agent_dev.core.impact_analyzer_improved import ImpactAnalyzer, ImpactAnalysisResult
from agent_dev.core.impact_analyzer_improved import RiskLevel, ImpactLevel
...
class TestImpactAnalyzer:
    ...
    def test_impact_analyzer_monotonicity(self, files_count, lines_count, functions_count):
    ...
    def test_dependency_cycle_detection(self):
        ...
        assert "cycle" in result.recommendations.lower() or "circular" in result.recommendations.lower()
    ...
    def test_performance_impact_assessment(self):
        ...
        assert "performance" in result.recommendations.lower() or "optimization" in result.recommendations.lower()
