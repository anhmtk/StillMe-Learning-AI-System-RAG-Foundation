...
class TestAgentDevChaos:
    ...
    def test_io_error_storm(self):
        ...
        # Simulate IO errors
        io_errors = ["EINTR", "EIO", "ENOSPC", "EROFS", "EACCES", "ENOENT"]
    ...
    def test_disk_full_simulation(self):
        ...
        for request in disk_full_requests:
            ...
            assert result is not None
            assert (
                "disk full" in str(result).lower()
                or "no space" in str(result).lower()
                or "cleanup" in str(result).lower()
            )
    ...
    def test_file_locked_handling(self):
        ...
        for request in locked_file_requests:
            ...
            assert result is not None
            assert (
                "locked" in str(result).lower()
                or "busy" in str(result).lower()
                or "retry" in str(result).lower()
            )
    ...
    def test_crash_mid_operation(self):
        ...
        for scenario in crash_scenarios:
            result = self.agentdev.execute_task(
                scenario, project_path=self.test_project, mode="senior"
            )

            # Should handle crash gracefully
            assert result is not None
            assert (
                "crash" in str(result).lower()
                or "recovery" in str(result).lower()
                or "rollback" in str(result).lower()
            )
    ...
    def test_idempotency_verification(self):
        ...
        for task in idempotent_tasks:
            ...
            result1 = self.agentdev.execute_task(
                task, project_path=self.test_project, mode="senior"
            )
            result2 = self.agentdev.execute_task(
                task, project_path=self.test_project, mode="senior"
            )
    ...
    def test_rollback_cleanup(self):
        ...
        for scenario in rollback_scenarios:
            ...
            assert result is not None
            assert (
                "rollback" in str(result).lower()
                or "cleanup" in str(result).lower()
                or "revert" in str(result).lower()
            )
    ...
    def test_rate_limiting_handling(self):
        ...
        for request in rate_limit_requests:
            ...
            assert (
                ...
                or "throttle" in str(result).lower()
                or "backoff" in str(result).lower()
            )
    ...
    def test_backoff_jitter(self):
        ...
        for scenario in backoff_scenarios:
            ...
            assert result is not None
            assert (
                "retry" in str(result).lower()
                or "backoff" in str(result).lower()
                or "jitter" in str(result).lower()
            )
    ...
    def test_memory_pressure_handling(self):
        ...
        for request in memory_pressure_requests:
            ...
            assert result is not None
            assert (
                "memory" in str(result).lower()
                or "optimize" in str(result).lower()
                or "efficient" in str(result).lower()
            )
    ...
    def test_concurrent_operation_handling(self):
        ...
        for request in concurrent_requests:
            ...
            assert result is not None
            assert (
                "concurrent" in str(result).lower()
                or "parallel" in str(result).lower()
                or "synchronize" in str(result).lower()
            )
    ...
    def test_resource_exhaustion_handling(self):
        ...
        for request in resource_exhaustion_requests:
            ...
            assert result is not None
            assert (
                "resource" in str(result).lower()
                or "exhaust" in str(result).lower()
                or "limit" in str(result).lower()
            )
    ...
    def test_corruption_recovery(self):
        ...
        for scenario in corruption_scenarios:
            ...
            assert (
                ...
                or "recover" in str(result).lower()
                or "repair" in str(result).lower()
            )
    ...
    def test_chaos_monkey_simulation(self):
        ...
        for scenario in chaos_scenarios:
            ...
            assert result is not None
            assert (
                "chaos" in str(result).lower()
                or "random" in str(result).lower()
                or "unpredictable" in str(result).lower()
            )
    ...
    def test_failure_cascade_prevention(self):
        ...
        for scenario in cascade_scenarios:
            ...
            assert result is not None
            assert (
                "cascade" in str(result).lower()
                or "isolate" in str(result).lower()
                or "contain" in str(result).lower()
            )
    ...
    def test_graceful_degradation(self):
        ...
        for scenario in stress_scenarios:
            ...
            assert result is not None
            assert (
                "degrade" in str(result).lower()
                or "adapt" in str(result).lower()
                or "graceful" in str(result).lower()
            )
