...
class TestAgentDevLearning:
    ...
    def test_experience_storage(self):
        ...
        assert all(exp["task"] in [e["task"] for e in stored_experiences] for exp in experiences)
    ...
    def test_learning_effectiveness(self):
        ...
        assert result is not None
        assert result.get("success", False)
        assert "effectiveness" in str(result).lower() or "learning" in str(result).lower()
    ...
    def test_learning_evaluation_comprehensive(self):
        ...
        assert result is not None
        assert result.get("success", False)
        assert "comprehensive" in str(result).lower() or "learning" in str(result).lower()
