...
from agent_dev.core.security_thinking import SecurityThinking, SecurityLevel, VulnerabilityAssessment
...
class TestSecurityThinking:
    ...
    def test_vulnerability_detection(self):
        ...
        vulnerable_code = {
            ...
            "code_snippets": [
                "SELECT * FROM users WHERE username = '" + user_input + "'",  # SQL injection
    ...
    def test_security_level_assessment(self):
        ...
        assert security_level in [SecurityLevel.LOW, SecurityLevel.MEDIUM, SecurityLevel.HIGH, SecurityLevel.CRITICAL]
    ...
    def test_security_best_practices_check(self):
        ...
        practices_result = self.security_thinking.check_best_practices(best_practices_code)
        ...
        assert len(practices_result["practices_followed"]) > len(practices_result["practices_missing"])
    ...
    def test_security_recommendations(self):
        ...
        vulnerable_data = {
            ...
            "missing_practices": ["input_validation", "output_encoding", "csrf_protection"]
        }
        
        recommendations = self.security_thinking.generate_security_recommendations(vulnerable_data)
        ...
        assert "input validation" in recommendation_text or "sql injection" in recommendation_text
