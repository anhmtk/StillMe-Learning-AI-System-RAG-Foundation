...
from agent_dev.core.business_thinking import BusinessThinking, BusinessPriority, ROIAnalysis
...
class TestBusinessThinking:
    ...
    def test_roi_calculation_idempotence(self, cost, revenue, time_to_market, market_size=1000000):
