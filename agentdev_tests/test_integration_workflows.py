...
from agent_dev.core.impact_analyzer_improved import ImpactAnalyzer
from agent_dev.core.business_thinking import BusinessThinking
from agent_dev.core.security_thinking import SecurityThinking
from agent_dev.core.cleanup_manager import CleanupManager
from agent_dev.core.conflict_resolver import ConflictResolver
...
""")
    ...
    def test_plan_evaluate_execute_validate_workflow(self):
        ...
        execution_result = self.agentdev.executor.execute_plan(plan_result, self.test_project)
    ...
    def test_cross_module_communication(self):
        ...
        security_result = self.agentdev.security_thinking.analyze_security(security_data)
    ...
    def test_learning_hooks_integration(self):
        ...
        success_rate = learning_stats["success_count"] / learning_stats["total_attempts"]
    ...
    def test_cleanup_integration(self):
        ...
        cleanup_result = self.agentdev.cleanup_manager.analyze_cleanup_opportunities(self.test_project)
        
        assert isinstance(cleanup_result, list)
        assert len(cleanup_result) > 0
        
        # Should detect temporary files
        temp_file_detections = [item for item in cleanup_result if "temp" in item.description.lower()]
